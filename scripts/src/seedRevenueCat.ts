...
const APP_STORE_APP_NAME = "WeName iOS";
const APP_STORE_BUNDLE_ID = "com.wename.ios";
const PLAY_STORE_APP_NAME = "WeName Android";
const PLAY_STORE_PACKAGE_NAME = "com.wename.android";
